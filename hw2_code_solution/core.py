...
NODE_BORDER_WIDTH = 3
NODE_COLOR_NORMAL = '#3492d9' # blue
NODE_COLOR_SOURCE = '#2cb64e'  # green
NODE_COLOR_OBSERVED = '#d96b34' # orange
NODE_COLOR_REACHABLE = NODE_COLOR_SOURCE # green
NODE_SHAPE_SOURCE = 'd'
LABEL_COLOR = '#111111'
